...
void call_1_PackedVector2Array_arg_ret_PackedByteArray(
  ...
  constructors.packed_vector2_array_from_variant_constructor(&arg1, (GDExtensionVariantPtr)p_args[0]);
...
void call_1_PackedByteArray_arg_ret_PackedVector2Array(
  ...
  constructors.packed_byte_array_from_variant_constructor(&arg1, (GDExtensionVariantPtr)p_args[0]);
